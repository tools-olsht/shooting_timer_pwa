...
const ASSETS = [
  ...
  '/shooting_timer_pwa/audio/prepare_en.mp3',
  '/shooting_timer_pwa/audio/prepare_es.mp3',
  '/shooting_timer_pwa/audio/attention_en.mp3',
  '/shooting_timer_pwa/audio/attention_es.mp3',
];
